...
def get_start_and_end_dates(start,end):
...
def searching_year(year, waiting_time):
...
def searching_start_end(start, end, waiting_time):
    dates = get_start_and_end_dates(start, end)
    scrap = WebScrap()
    for day, month, year in dates:
        print(day, month, year)
        scrap.get_elements_from_web(year, month, day, waiting_time)
